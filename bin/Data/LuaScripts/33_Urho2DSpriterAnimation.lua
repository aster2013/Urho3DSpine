...
function CreateScene()
    ...
    local spineAnimationSet = cache:GetResource("AnimationSet2D", "Urho2D/spineboy/spineboy.json")
    if spineAnimationSet == nil then
        return
    end

    spineNode = scene_:CreateChild("SpineAnimation")
    spineNode:SetPosition2D(Vector2(-2.0, -1.0))
...
function HandleMouseButtonDown(eventType, eventData)
    local spineAnimatedSprite = spineNode:GetComponent("AnimatedSprite2D")
    local spineAnimationSet = spineAnimatedSprite.animationSet
